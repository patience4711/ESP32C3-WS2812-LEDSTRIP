...
//int8_t last_level = 50; // at boot this needs a value

#define DEFAULT_POWER_MODE   true
#define DEFAULT_LEVEL 50
#define DEFAULT_SATURATION   100
#define DEFAULT_HUE           50     // 0 is Rood
...
//Adafruit_NeoPixel pixels = Adafruit_NeoPixel(NUMPIXELS, gpio_strip, NEO_GRB + NEO_KHZ800);
